              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-money"></i> VENTA <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="PruebaVenta.php">Crear Venta</a></li>
                      ...
                      <li><a href="modificarApartado.php">Modificar Apartado</a></li>
        ...
        <div class="row ">
            <div class="col-sm-3">
                ...
                <div class="card-body">
                    ...
                    <form>
                        <fieldset>
                            <legend>Creacion del apartado</legend>
                            <div class="mb-3">
                                <label for="id" class="form-label">ID</label>
                                <select id="id" class="form-select">
                                  <option value="cliente uno">ID</option>
                                </select>
                            </div>
                            <div class="mb-3">
                                <label for="pieza" class="form-label">Nombre de la pieza</label>
                                <select id="pieza" class="form-select">
                                  <option value="cliente uno">pieza</option>
                                </select>
                            </div>
                            <div class="mb-3">
                                <label for="totalPieza" class="form-label">Total de piezas</label>
                                <select id="totalPieza" class="form-select">
                                  <option value="cliente uno">total piezas</option>
                                </select>
                            </div>
                            <div class="mb-3">
                                <label for="ProductoSelect" class="form-label">Total de producto</label>
                                <select id="ProductoSelect" class="form-select">
                                  <option value="producto uno">Producto uno</option>
                                </select>
                            </div>
                            <div class="mb-3">
                                <label for="CantidadInput" class="form-label">Cantidad abonada</label>
                                <input type="number" id="CantidadInput" class="form-control" placeholder="Unidad">
                                <option value="producto uno">Abono</option>
                            </div>
                            <div class="mb-3">
                                <label for="CantidadRes" class="form-label">Cantidad restante</label>
                                <input type="number" id="CantidadRes" class="form-control" placeholder="$$$" disabled=" ">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <label for="fechaLim" class="form-label">Fecha limite de pago</label>
                                <input type="number" id="fechaLim" class="form-control" placeholder="DD/MM/AA">
                            </div>
                            <div class="mb-3">
                                <label for="LiquidacionPie" class="form-label">Liquidacion de pieza</label>
                                <input type="number" id="LiquidacionPie" class="form-control" placeholder="00.00">
                            </div>
                            <div class="mb-3">
                                <label for="Firma" class="form-label">Firma del cliente </label>
                                <input type="number" id="Firma" class="form-control" placeholder="">
                            </div>
                            <div class="mb-3">
                                <label for="VendedorAsig" class="form-label">vendedor </label>
                                <input type="number" id="VendedorAsig" class="form-control" placeholder="">
                            </div>
                            <div class="mb-3">
            ...
            <div class="col-sm-9">
              <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Apartados creados </h5>
                    ...
                    <a href="#" class="btn btn-outline-dark">Aceptar</a>
                </div>
              </div>
            </div>
        </div>
